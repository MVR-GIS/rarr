...
risk_table              <- read_csv(system.file("extdata", 
                                                "RISK_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
events_table            <- read_csv(system.file("extdata", 
                                                "EVENTS_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
discussion_table        <- read_csv(system.file("extdata",
                                                "DISCUSSION_LOG_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
action_table            <- read_csv(system.file("extdata", 
                                                "ACTION_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
decision_table          <- read_csv(system.file("extdata",
                                                "DECISION_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_action_action_table <- read_csv(system.file("extdata",
                                                "REL_ACTION_ACTION_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_dec_dec_table       <- read_csv(system.file("extdata",
                                                "REL_DEC_DEC_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_dec_action_table    <- read_csv(system.file("extdata",
                                                "REL_DEC_ACTION_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_risk_action_table   <- read_csv(system.file("extdata",
                                                "REL_RISK_ACTION_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_risk_dec_table      <- read_csv(system.file("extdata",
                                                "REL_RISK_DEC_MAIN_VIEW.csv",
                                                package = "rarr"),
                                    show_col_types = FALSE)
rel_risk_risk_table     <- read_csv(system.file("extdata",
...
risk_table       <- convert_date(risk_table)
events_table     <- convert_date(events_table)
discussion_table <- convert_date(discussion_table)
action_table     <- convert_date(action_table)
decision_table   <- convert_date(decision_table)
```
...
risk_table              <- ROracle::dbReadTable(con_roracle, 
                                                "RISK_MAIN_VIEW")
events_table            <- ROracle::dbReadTable(con_roracle, 
                                                "EVENTS_MAIN_VIEW")
discussion_table        <- ROracle::dbReadTable(con_roracle, 
                                                "DISCUSSION_LOG_MAIN_VIEW")
action_table            <- ROracle::dbReadTable(con_roracle, 
                                                "ACTION_MAIN_VIEW")
decision_table          <- ROracle::dbReadTable(con_roracle, 
                                                "DECISION_MAIN_VIEW")
rel_action_action_table <- ROracle::dbReadTable(con_roracle, 
                                                "REL_ACTION_ACTION_MAIN_VIEW")
rel_dec_dec_table       <- ROracle::dbReadTable(con_roracle, 
                                                "REL_DEC_DEC_MAIN_VIEW")
rel_dec_action_table    <- ROracle::dbReadTable(con_roracle, 
                                                "REL_DEC_ACTION_MAIN_VIEW")
rel_risk_action_table   <- ROracle::dbReadTable(con_roracle, 
                                                "REL_RISK_ACTION_MAIN_VIEW")
rel_risk_dec_table      <- ROracle::dbReadTable(con_roracle, 
                                                "REL_RISK_DEC_MAIN_VIEW")
rel_risk_risk_table     <- ROracle::dbReadTable(con_roracle, 
